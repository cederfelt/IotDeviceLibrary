...
namespace Iot.Device
{
    ...
    public class TCS34725 : ITCS34725
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
             ...
             //   DeviceInformationCollection dic = await DeviceInformation.FindAllAsync(aqs);
                ...
                I2CDevice = new UnixI2cDevice(settings);//.FromIdAsync(dic[0].Id, settings);
        ...
        protected TCS34725(byte address, byte signature)
        {
            Address = address;
            Signature = signature;
        }
        ...
        /// <summary>
        /// onverts the raw R/G/B values to lux 
        /// </summary>
        /// <param name="r"></param>
        /// <param name="g"></param>
        /// <param name="b"></param>
